...
export function VariantSplit({ data, setData, errors, onSubmit }: VariantSplitProps) {
  return (
    <div className="mx-auto max-w-6xl rounded-2xl bg-white shadow-lg overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-3">
        <aside className="hidden border-r border-slate-200 md:block md:col-span-1 bg-slate-50">
          <div className="sticky top-0 h-full p-6">
            <h2 className="text-lg font-semibold text-slate-900">Campaign Intake</h2>
            <ol className="mt-6 space-y-3 text-sm text-slate-600">
              <li className="flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-200 text-xs font-semibold">1</span>
                Basics
              </li>
              <li className="flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-200 text-xs font-semibold">2</span>
                Dates & Budget
              </li>
              <li className="flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-200 text-xs font-semibold">3</span>
                Geo Targeting
              </li>
              <li className="flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-200 text-xs font-semibold">4</span>
                Placements
              </li>
              <li className="flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-200 text-xs font-semibold">5</span>
                Creative Files
              </li>
              <li className="flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-200 text-xs font-semibold">6</span>
                Links & Email
              </li>
              <li className="flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-200 text-xs font-semibold">7</span>
                Payment
              </li>
            </ol>
            <div className="mt-8 rounded-xl bg-white p-4 text-xs text-slate-600 border border-slate-200">
              <p className="font-medium text-slate-900 mb-1">Tip</p>
              Sidebar stays visible while you fill the form.
            </div>
          </div>
        </aside>
