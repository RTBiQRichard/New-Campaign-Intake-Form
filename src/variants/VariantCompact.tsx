...
export function VariantCompact({ data, setData, errors, onSubmit }: VariantCompactProps) {
  return (
    <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-3">
      <div className="md:col-span-2 rounded-2xl bg-white p-6 shadow-lg">
        ...
        <p className="text-sm text-slate-500">Compact single-column with sticky summary</p>
